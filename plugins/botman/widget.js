!(function(t) {
    ...
    function(t, e, n) {
        ...
        function r(t, e) {
            ...
            for (
                e &&
                null != e.children &&
                (U.length || U.push(e.children), delete e.children); U.length;
        ...
        function k(t, e, n, o, r) {
            t._disable ||
                ((t._disable = !0),
                    ...
                    (t.__key = e.key) && delete e.key, !t.base || r ?
        ...
        function E(t, e, n, o) {
            for (
                var r = t && t._component,
                    ...
                    c = s,
                    u = p(e); r && !c && (r = r._parentComponent);
            ...
            return new Promise(function(e, p) {
                ...
                if (
                    (d.open(
                            ...
                            i(t.url, t.params, t.paramsSerializer), !0
                        ),
                        (d.timeout = t.timeout),
                        (d[h] = function() {
                            if (
    ...
    function(t) {
        ...
        function n(t) {
            for (
                var n, r, i = t + "", a = "", s = 0, c = o; i.charAt(0 | s) || ((c = "="), s % 1); a += c.charAt(63 & (n >> (8 - (s % 1) * 8)))
            ) {
                ...
                return {
                    write: function(t, e, n, r, i, a) {
                        ...
                        s.push(t + "=" + encodeURIComponent(e)),
                            ...
                            o.isString(i) && s.push("domain=" + i), !0 === a && s.push("secure"),
            ...
            return (
                ...
                (e.prototype.render = function(t) {
                    ...
                    return Object(o.b)(
                        ...
                        Object(o.b)(
                            "div", {
                                className: "desktop-closed-message-avatar chatbutton",
                                onload: notificationSound(),
                                style: a({
                                        background: e.bubbleBackground
                                    },
                                    r.b
